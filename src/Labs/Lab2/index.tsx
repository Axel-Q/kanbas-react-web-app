...
export default function Lab2() {
    return (
        <div className='container'>
            <h2>Lab2 - Cascading style sheet</h2>
            ...
            <div id='wd-css-class-selectors'>
                ...
                <p className='wd-class-selector'>
                    testing using class selector. example1
                </p>
                <h2 className='wd-class-selector'>
                    testing using class slector example2
                </h2>
            </div>
            ...
            <div id="wd-css-borders">
                ...
                <p className="wd-rounded-corners-top wd-border-thin 
                                wd-border-blue wd-border-dashed wd-padding-fat">
            ...
            <div id="wd-float-divs">
                ...
                <div>
                    <div className="wd-float-left wd-dimension-portrait wd-bg-color-yellow">
                        Yellow </div>
                    <div className="wd-float-right wd-dimension-portrait wd-bg-color-blue wd-fg-color-white">
                        Blue </div>
                    <div className="wd-float-right wd-dimension-portrait wd-bg-color-red">
                        Red </div>
        ...
        wd-fg-color-white">
            ...
            <div id="wd-css-styling-tables">
                ...
                <table className="table">
                    ...
                    <tbody>
                        <tr className="table-warning"><td>Q1</td><td>HTML</td><td>2/3/21</td><td>99</td></tr>
                        <tr className="table-danger"><td>Q2</td><td>CSS</td><td>2/10/21</td><td>99</td></tr>
                        <tr className="table-primary"><td>Q3</td><td>JavaScript</td><td>2/17/21</td><td>99</td></tr>
                    </tbody>
                    <tfoot>
                        <tr className="table-success"><td colSpan={3}>Average</td><td>9</td></tr>
                    </tfoot>
                </table>
            </div>
            ...
            <div id="wd-css-navigating-with-tabs">
                ...
                <ul className="nav nav-tabs">
                    <li className="nav-item">
                        <a className="nav-link active bg-warning" href="123">Active</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="123">Link</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="123">Link</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link disabled" href="123">Disabled</a>
                    </li>
                </ul>
            </div>
            <TOC/>
